...
| **Max Packet Size** | max_allowed_packet ≥16MB | Between 1MB-16MB | <1MB |
...
| **SQL Mode** | No problematic modes | ONLY_FULL_GROUP_BY enabled | Database not available |
...
| **Table Prefix** | 3+ character prefix (not "jos_") | Default "jos_" OR <3 chars | - |
...
| **max_execution_time** | ≥60 seconds | 30-60 seconds | <30 seconds |
| **max_input_time** | ≥60 seconds | 30-60 seconds | <30 seconds |
| **max_input_vars** | ≥2500 | 1000-2500 | <1000 |
| **Mbstring Extension** | Mbstring installed | - | Mbstring missing |
| **memory_limit** | ≥256MB | 128-256MB | <128MB |
...
| **upload_max_filesize** | ≥64MB | 2-64MB | <2MB |
