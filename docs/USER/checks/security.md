---
description: "21 security health checks for Joomla: SSL, file permissions, password policies, two-factor auth, admin protection, and more."
---
...
3. Check `.htaccess` doesn't enable display_errors
