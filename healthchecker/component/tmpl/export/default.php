...
Text::script('COM_HEALTHCHECKER_EXPORT_SUMMARY_FORMAT');
Text::script('COM_HEALTHCHECKER_EXPORT_SUMMARY_ISSUES_ONLY');
Text::script('COM_HEALTHCHECKER_EXPORT_SUMMARY_CATEGORIES');
Text::script('COM_HEALTHCHECKER_EXPORT_SUMMARY_CHECKS');
