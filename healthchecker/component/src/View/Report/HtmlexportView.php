...
<head>
    ...
    <title><?php echo Text::_('COM_HEALTHCHECKER_REPORT'); ?> - <?php echo htmlspecialchars($siteName); ?></title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        <div class="header">
            ...
            <div class="subtitle">
                <?php echo Text::sprintf(
                    'COM_HEALTHCHECKER_REPORT_GENERATED_ON',
                    $reportDate,
                ); ?> | Joomla <?php echo htmlspecialchars($joomlaVersion); ?>
            </div>
        </div>
                                ...
                                <?php if ($categoryResult->docsUrl !== null): ?>
                                    <div class="check-footer">
                                        <a href="<?php echo htmlspecialchars(
                                            $categoryResult->docsUrl,
                                        ); ?>" target="_blank" rel="noopener"><?php echo Text::_('COM_HEALTHCHECKER_REPORT_DOCUMENTATION'); ?></a>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
<?php endforeach;
        ...
        <div class="footer">
            <?php echo Text::_('COM_HEALTHCHECKER_REPORT_GENERATED_BY'); ?> <a href="https://www.joomlahealthchecker.com/" target="_blank">Health Checker for Joomla</a>
            | <?php echo Text::_('COM_HEALTHCHECKER_REPORT_FREE_EXTENSION'); ?> <a href="https://mysites.guru" target="_blank">mySites.guru</a>
            <?php
            $presentProviders = [];
        ...
        ?>
            | <?php echo Text::_('COM_HEALTHCHECKER_REPORT_COMMUNITY_PLUGINS'); ?> <?php echo implode(', ', $pluginLinks); ?>
            <?php endif; ?>
        </div>
    </div>
</body>
